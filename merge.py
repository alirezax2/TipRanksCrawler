...
DFtotal1 = pd.read_csv(rf"tipranks/tipranks_{current_datetime}_part1.csv")
DFtotal2 = pd.read_csv(rf"tipranks/tipranks_{current_datetime}_part2.csv")
...
upload_to_hf_dataset(
    file_path, DATASET_NAME_TIPRANKS_OUTPUT, HF_TOKEN_TIPRANKS, repo_type="dataset"
)
upload_to_hf_dataset(
    latest_file_path,
    DATASET_NAME_TIPRANKS_OUTPUT,
    HF_TOKEN_TIPRANKS,
    repo_type="dataset",
)
